...
<body>
    <div class="container mt-5">
        ...
        $deskripso = "Buku ini membahas pemrograman web menggunakan PHP dan MySQL secara lengkap dari dasae hingga mahir";
        ?>
    ...
    <script src="htpps://ddn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
</body>
<html>